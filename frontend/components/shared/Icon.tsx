const PATHS: Record<string, React.ReactNode> = {
  ...
  palette: (
    <>
      ...
      <path d="M12 2a10 10 0 0 0 0 20c1 0 2-.8 2-2 0-.5-.2-1-.5-1.4-.3-.3-.5-.8-.5-1.3 0-1 .8-1.8 1.8-1.8h2.1A4.1 4.1 0 0 0 21 11.5C21 6.3 16.9 2 12 2Z" />
    </>
  ),
...
/** Espelha o helper icon() do protótipo — mesmo conjunto de ícones SVG. */
